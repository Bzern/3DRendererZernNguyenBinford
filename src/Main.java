...
public class Main {
	...
	//	v.slope.printVector();
		...
		z.faces[0].bordercolor = Color.white;
		z.faces[0].fillcolor = Color.red;
		...
		z.faces[2].bordercolor = Color.white;
		z.faces[2].fillcolor = Color.blue;
		...
		z.faces[3].bordercolor = Color.white;
		z.faces[3].fillcolor = Color.green;
		...
		z.faces[4].bordercolor = Color.white;
		z.faces[4].fillcolor = Color.orange;
		...
		z.faces[5].bordercolor = Color.white;
		z.faces[5].fillcolor = Color.magenta;
		...
		z.faces[1].bordercolor = Color.white;
		z.faces[1].fillcolor = Color.black;
